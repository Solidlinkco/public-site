                ...
                <StyledContactCards>
                            ...
                            {phone
                                ...
                                ?.map((el) => (
                                    <p class="fz-18 fw-700" style={{ color: '#400436' }} key={el?.value}>
                                        <a className="fz-18" href={`tel:${el?.value}`}>
                                            {el?.value}
                                        </a>
                                    </p>
                                ))}
                    ...
                    {email && (
                        <div>
                            ...
                            <a className="fz-18" href={`mailto:${email?.value}`}>
                                {email?.value}
                            </a>
                        </div>
                    )}
                ...
                <StyledContactCards>
                    ...
                    <div>
                        ...
                        <p className="fz-18 fw-700" style={{ color: '#400436' }}>
                            <a className="fz-18" href="tel:+2349133700236">
                                +2349133700236
                            </a>
                        </p>
                    </div>
            ...
            <div className="col-12 centered collapse-mobile">
                ...
                <StyledContactCards>
                    ...
                    <div>
                        ...
                        <p className="fz-20 fw-700">Call us</p>
                        <p className="fz-18 fw-700" style={{ color: '#400436' }}>
                            <a className="fz-18" href="tel:+2349085500067">
                                +2349085500067
                            </a>
                        </p>
                    </div>
            ...
            <div className="col-12 centered collapse-mobile">
                ...
                <StyledContactCards>
                    <div>
                        <BusinessIcon />
                        <p className="fz-20 fw-700">Visit us</p>
                        <p>Solid-Link Consulting, 62, NNPC Pipeline Road, Gaa-Akanbi, Ilorin.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="fz-20 fw-700">Call us</p>
                        <p className="fz-18 fw-700" style={{ color: '#400436' }}>
                            <a className="fz-18" href="tel:+2348032294612">
                                +2348032294612
                            </a>
                        </p>
                    </div>
