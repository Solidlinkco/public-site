...
const BrochureModal = () => {
    const { brochureOpen, toggleBrochure } = useBrochureContext();
        ...
        <>
            ...
            <StyledBrochureModal>
                <StyledHeader>
                    ...
                    <StyledCloseButton onClick={toggleBrochure}>
                        <span>&times;</span>
                    </StyledCloseButton>
                </StyledHeader>
                ...
                <StyledBrochureContainer>
                    ...
                    <StyledBrochureCard
                        href="/assets/solidLink-secondary-school-brochure-mini.pdf"
                        {...EXTERNAL_LINKS_PROPS}
                    >
                        <PdfIcon />
