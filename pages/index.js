...
export async function getStaticProps() {
    ...
    const { homepages, reviews, servicesCards, blogs } = await graphcms.request(GET_HOMEPAGE);
    const instaArr = [];
...
export default function Home({ contacts, homepages, reviews, servicesCards, instaData, blog }) {
    return <Homepage contacts={contacts} homepage={homepages[0]} reviews={reviews} servicesCards={servicesCards} instaData={instaData} blog={blog} />;
}
